...
詳細な仕様・実装については [`default_mcp_server/DeskToDo/README.md`](default_mcp_server/DeskToDo/README.md) および [`secretary_mcp_spec.md`](default_mcp_server/DeskToDo/secretary_mcp_spec.md) を参照してください。